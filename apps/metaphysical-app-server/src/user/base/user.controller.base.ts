...
import { SettingsFindManyArgs } from "../../settings/base/SettingsFindManyArgs";
...
export class UserControllerBase {
  ...
  async findSettingsItems(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput
  ): Promise<Settings[]> {
    const query = plainToClass(SettingsFindManyArgs, request.query);
    const results = await this.service.findSettingsItems(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/settingsItems")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async connectSettingsItems(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: SettingsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      settingsItems: {
        connect: body,
  ...
  @common.Delete("/:id/settingsItems")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectSettingsItems(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: SettingsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
